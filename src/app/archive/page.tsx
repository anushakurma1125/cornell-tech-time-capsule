                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-3">
                      {data.dominantThemes.slice(0, 4).map((theme) => (
                        <span
                          key={theme}
                          className="text-[11px] px-2 py-0.5 bg-parchment rounded-full text-text-muted font-medium"
                        >
                          {theme}
                        </span>
                      ))}
                    </div>
                    <div className="mt-4 text-cornell-red text-sm font-semibold group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                      Open year folder
